    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'K4bjHBSFR2g&t=4705s', title: 'Refatoração ao extremo', duration: '2:58:54' },
...
describe('player slice', () => {
  ...
  it('should not update the current module and lesson index if there is no next lessson available', () => {
